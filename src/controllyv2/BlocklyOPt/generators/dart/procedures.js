...
var args = [];
var tempo=[];//This variable checks the type of variables
...
Blockly.Dart['procedures_defreturn'] = function(block) {
  ...
  var returnValue = Blockly.Dart.valueToCode(block, 'RETURN',
    Blockly.Dart.ORDER_NONE) || '';
var returnType = Blockly.Dart.variableType_['setup_var' + returnValue];
if (returnType!=undefined) {

  returnValue = '  return ' + returnValue + ';\n';
}else{
 returnValue = '  return;'+'\n';
 returnType = 'void'; //Type void if no return by default
}
  var args = [];
