...
Blockly.Blocks['procedures_mutatorcontainer'] = {
  ...
  init: function() {
    ...
    this.appendStatementInput('STACK');
    //this.appendDummyInput()
      //  .appendField("Var Type")
        //.appendField(new Blockly.FieldDropdown([["int", "Int"], ["float", "Float"], ["char", "Char"]]), "ArgumentType");
...
Blockly.Blocks['procedures_mutatorarg'] = {
  ...
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput(' ', this.validator_), 'NAME');
    //this.appendDummyInput()
      //  .appendField("Var Type")
        //.appendField(new Blockly.FieldDropdown([["int", "Int"], ["float", "Float"], ["char", "Char"]]), "ArgumentTypeb");
